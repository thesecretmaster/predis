...
typedef int (*meta_command_func)(struct predis_ctx *ctx, void *global_ht_table /* I know this should be type checked but tbh this is a bit of a hack */, char **argv, argv_length_t *argv_lengths, int argc, struct gc_user *gc_usr);
